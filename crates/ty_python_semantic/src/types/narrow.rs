...
impl<'db> PatternSuccessAnalyzer<'db> {
    ...
    fn analyze_pattern_subject_arms(
        ...
        let mut result = self.analyze_pattern_subject_arms_impl(
            subject_ty,
        ...
        for expanded_subject_ty in expanded_subject_types {
            ...
            filtering_result.stable_subject_ty = UnionType::from_two_elements(
                self.db,
                filtering_result.stable_subject_ty,
                expanded_result.stable_subject_ty,
            );
